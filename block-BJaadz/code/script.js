...
// Change the border of hr with class 'image' to `2px solid purple`.
     let hrBorder = document.querySelector  ('.image');
      hrBorder.style.border = '2px solid purple'; 
// Hide the box number 17 (last box).
   //doubt
  //  document.removeChild('17');
// Change the border of all the hr element from solid to dashed type
// allHrs.forEach((color) => color.style.border = '1px dashed tomato');
...
// Remove all the elements from box 
    //doubt
